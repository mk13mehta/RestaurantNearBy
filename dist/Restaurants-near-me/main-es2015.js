...
let GetRestaurantsService = class GetRestaurantsService {
...
GetRestaurantsService.ctorParameters = () => [
...
let ProfilePageComponent = class ProfilePageComponent {
    constructor(route, getRestaurantsService) {
        this.route = route;
...
let SearchPageComponent = class SearchPageComponent {
    constructor(getRestaurantsService, router) {
        this.getRestaurantsService = getRestaurantsService;
        this.router = router;
        this.searchValue = "";
    }
    ...
    searchNow() {
        this.getRestaurantsService.getSearchPlaces(this.searchValue).subscribe(result => {
